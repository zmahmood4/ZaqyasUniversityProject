/*
 *Version 2 of the code which implements the sections of the airfield
 *Has 6 gates, landing sensor, takeoff sensor, and an emergency gate
 *1 push button for all gates to get to emergency gate
 *1 push button for all gates to get to takeoff sensor
 *takeoff sensor only works if no plane is on the airfield taxiway and a plane is parked at a gate
 */
...
void loop()
{
  ...
  landing_takeoff(); //call landing function
